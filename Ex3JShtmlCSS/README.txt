...
Date: 2022-03-12
Topic: Html, CSS and JS Data Plots

##########################Background###########################

This is a one page website template to plot mock data (not real research data)
of plant heights and genotypes. The plots are used to visualize how
plant height changes with genotype in this mock data created for this exercise.
The website is types in html, styled with css and graphs computed with javascript(js).
...
2) Three Core Skills Every Web Developer Needs by Tim Buchalka | The Learn Programming Channel
https://youtu.be/RiXONOZ6Cvc
3) Introductory To JavaScript - Learn The Basics of JavaScript by Robin Haney
https://www.udemy.com/course/the_complete_javascript_course_for_beginners/
4) The Full Stack Web Development Bootcamp 2022 by Darragh O'Neill, especially
Sections 'Making The Imperial Donuts Website' and 'Introduction to Javascript'
https://www.udemy.com/course/the-full-stack-web-development-bootcamp-2020/
5) The Web Developer Bootcamp 2022 by Colt Steele, especially
Sections 'HTML: The Essentials', 'CSS: The Very Basics' and 'JavaScript Decision Making'
https://www.udemy.com/course/the-web-developer-bootcamp/
6) JavaScript Essentials 2020 Mini Course by Kalob Taulien
https://www.udemy.com/course/javascript-essentials-mini-course/
7) JavaScript Full Course for Beginners | Complete All-in-One Tutorial | 8 Hours by Dave Gray
https://youtu.be/EfAl9bwzVZk
8) D3.js - A Practical Introduction by Maximilian Schwarzmüller | Academind
https://youtu.be/TOJ9yjvlapY
9) JavaScript Tutorial 5 Dynamic Image Manipulation by Derek Banas
https://youtu.be/zeTPUdhfJOk
10) Laxxx.js - An Awesome Scroll Animation Library that's Only 2KB! by DesignCourse
https://youtu.be/jaVy3SCibJw
11) Build a Todo list app in HTML, CSS & JavaScript in 2021 | JavaScript for Beginners tutorial by Tyler Potts
https://youtu.be/MkESyVB4oUw
12) Beautiful Chart Animation with Chart Js Tutorial by DevEd
https://youtu.be/fqARSwfsV9w
##########################Thank You####################################
